...
- Documentation interface screenshots use an empty, isolated demo instance and the app's built-in placeholder illustration; they do not contain personal albums.
